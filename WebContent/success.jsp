...
<div class="menubar">
	...
	<br><br><br>
	<div class ="contt">
	<form action="backtohome" method="post" align="center">
		<h1>Process is successful.</h1>
		<h3>Account details are sent to the bank. The amount will be deducted from your account. <br>
		Bank will validate your account details and if its successful you will receive the receipt via email.<br>
		After the validation the ownership documents will be sent to your email.<br><br>
		Thank you for choosing us.</h3>
		<input type="submit" name="backbtn" value="Go back to Home-Page">
	</form>
		</div>
		<br><br><br><br>
		<br><br>
